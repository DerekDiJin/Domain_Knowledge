...
for i=1:N_train
    ...
    data_matrix_t(all, all) = 0;
    data_matrix = data_matrix + data_matrix_t;
...
%     core = core_numbers(data_matrix);
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
    locals = localFeatures(all, data_matrix, src, dst, m, n, 'weight');
    
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    if extra == 1
        temp = [degree pr closeness hubs authorities cc betweennes EigenVector NetworkConstraint locals{1} locals{2} locals{3} locals{4} locals{5} locals{6} communities wcc scc rolx];
    elseif extra == 0
        temp = [degree pr closeness eigenvector cc betweennes locals{1} locals{2} locals{3} locals{4}];
    end
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % 
%     G.Nodes.PageRank = pr;
