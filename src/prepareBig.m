...
[G_b theFiles_train_names_str] = prepareBig_extractFiles(theFiles_train, dataFolder_train, extra);%prepareBig_extractFiles_undirec_wei(theFiles_train, dataFolder_train, extra);
